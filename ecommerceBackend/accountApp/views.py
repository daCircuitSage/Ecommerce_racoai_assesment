...
from accountApp.serializers import UserRegistrationSerializer, UserLoginSerializer, UserProfileViewSrializer, UserChangePasswordSerializer, SendPasswordRestEmailSerializer, UserPassResetSerializer
...
class UserLoginView(APIView):
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            # authenticate expects `username` kwarg for default backend; use username=email
